package com.common.androidexample.view.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.xiaodong.basetools.view.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.xiaodong.basetools.view.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
            setTextSize(mDelegate.getWeekTextSize());
            setTextColor(mDelegate.getWeekTextColor());
            setBackgroundColor(mDelegate.getWeekBackground());
        }
    }
