...
public class JButton extends AppCompatButton {
    ...
    public JButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        /*
        *主操作背景：R.drawable.lib_jbtn_blue_bg
        *次要操作背景：R.drawable.lib_jbtn_line_bg
        *弱操作背景：R.drawable.lib_jbtn_line_gray_bg
        * 禁用状态背景：R.drawable.lib_jbtn_forbidden_bg
        * */
        switch (style) {
            case 0:
                setBackgroundResource(R.drawable.lib_jbtn_blue_bg);
                break;
            case 1:
                setBackgroundResource(R.drawable.lib_jbtn_line_bg);
                break;
            case 2:
                setBackgroundResource(R.drawable.lib_jbtn_line_gray_bg);
                break;
            default:
                setBackgroundResource(R.drawable.lib_jbtn_blue_bg);
        }
