...
public class ExampleActivity extends CommonActivity {
            ...
            public void onBtnClick(View view, int position) {
                ...
                switch (beanWraper.name) {
                    ...
                    case "chapter7":
                        ...
                        break;
                    case "自定义控件三部曲":
                        intent = new Intent(ExampleActivity.this, CustomAnimalActivity.class);
                        break;
                    case "首页复杂布局":
                        intent = new Intent(ExampleActivity.this, HomeLayoutActivity.class);
                        break;
                }
                if (intent == null) {
                    return;
