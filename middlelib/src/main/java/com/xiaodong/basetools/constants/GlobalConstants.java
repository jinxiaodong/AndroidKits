package com.xiaodong.basetools.constants;
...
public class GlobalConstants extends BaseConstants {
    ...
    public static String HX_APPID = "C7D84F4B";
    public static String USER_CENTER_APPSECRET = "e0d1b3cc3bf3fb4e6a7bb9189e464b38b62c8feb";
