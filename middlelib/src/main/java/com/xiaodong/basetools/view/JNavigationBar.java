...
public class JNavigationBar extends FrameLayout {
    ...
    public JNavigationBar(@NonNull Context context) {
        this(context, null);
    }

    public JNavigationBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JNavigationBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        mContext = context;
        getContext();
        View view = LayoutInflater.from(mContext).inflate(R.layout.base_common_header, this);
    ...
    public void setBlackMode() {
        titleBarGroup.setBackgroundResource(R.color.base_color_gray_f9f9f9);
        titleBarBack.setImageResource(R.drawable.icon_back_gray);
        titleBarTitleText.setTextColor(getResources().getColor(R.color.base_color_gray_444444));
        titleBarOk.setTextColor(getResources().getColor(R.color.base_color_gray_444444));
        ivShareInformation.setImageResource(R.drawable.share_gray);
        ivButtonRight.setImageResource(R.drawable.icon_plus_gray);
    }
